// lra_core.js - Core logic for Laporan Realisasi Anggaran
window.LraCore = {
  db: null,
  userProfile: null,
  schoolProfile: null,
...
Susunlah dokumen ini secara lengkap, detil, tanpa teks pemotong, siap pakai, dan dalam format Markdown lengkap dengan struktur penulisan resmi.`;
      ...
      console.error('[LraCore] AI Error:', err);
      onError(err);
    }
  },
  ...
  async saveDraft(payloadData, userPrompt) {
    ...
    const docId = `${this.userProfile.uid || 'guest'}_b_lra`;
